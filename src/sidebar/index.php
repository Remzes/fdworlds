<?PHP
include($_SERVER['DOCUMENT_ROOT'] . "/lk/class/dev.php");
$dev = new Dev(0, $_SERVER, false);
//if( $_SERVER['REMOTE_ADDR'] === "213.137.248.21" ) var_dump($_SERVER);
?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
    <meta name="description" content="FDWorlds.com - Лучшие сервера и отзывчивая администрация."/>
    <meta name="keywords"
          content="FTB, feed-the-beast, Beyond, direwolf20, SkyFactory 3, без вайпов, fdworlds, minecraft, kingdoms, skyblock, skywars, лицензионный, pvp, моды, 1.7.10, 1.10, магический"/>
    <meta name="author" content="fdworlds"/>
    <meta name="copyright" content="FDWorlds"/>
    <meta property="og:image" content="/img/favicon.png">
    <title>FDW</title>
    <link href="/preview/style.css" rel="stylesheet"/>
    <link href="/preview/index2252.css" rel="stylesheet"/>
    <link href="/preview/jquery.qtip.css" rel="stylesheet"/>
    <link href="/img/favicon.ico" rel="shortcut icon"/>
    <link href="/img/favicon.png" rel="apple-touch-icon-precomposed apple-touch-icon" sizes="64x64"/>
    <!--[if lt IE 9]>
...
<div class="sidebar" style="width: 240px;">
    ...
    <div class="vote">
        ...
        <div class="vote-banners" style="padding: 4px;">
            <a alt="Голосуй за нас в ТОПе" href="http://monitoringminecraft.ru/top/fdworlds"><img
                        src="http://monitoringminecraft.ru/top/fdworlds/widget1.png"/></a>
            <a href="http://mcrate.su/rate/6806" target="_blank"><img src="http://mcrate.su/bmini.png"></a>
            <a href="https://fairtop.in/project/994" target="_blank"><img
                        src="../templates/theme/images/fairtop_logo.png" style="width: 88px;"></a>
            <a href="http://www.minecraftforum.net/servers/10928-fantasy-dream-worlds/vote" target="_blank"><img
                        src="../templates/theme/images/mcforum.png" style="width: 88px;"></a>
            <a href="http://ftbservers.com/server/GghfqU9c/vote" target="_blank"><img
                        src="../templates/theme/images/ftbservers.png" style="width: 180px;"></a>
        </div>
